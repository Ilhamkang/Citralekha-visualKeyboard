...
TextArea = scrolledtext.ScrolledText(root,width=62,height=15,wrap=WORD,padx=2,pady=4,borderwidth=1,relief=RIDGE)
...
for button in buttons:
    ...
    if button !='Spasi':
        Button(root, font=text_font, text=button,width=2,bg='black',fg='white',activebackground="white",activeforeground='black',
            relief='raised',padx=6,pady=2,bd=4,command=command).grid(row=varrow,column=varcolumn)
    if button =='Spasi':
        Button(root,text=button,width=2,bg='grey',fg='white',activebackground="white",activeforeground='black',
            relief='raised',padx=76,pady=2,bd=8,command=command).grid(row=8,columnspan=4)
